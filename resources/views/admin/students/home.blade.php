...
@section('content')
    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="contentblock">
                ...
                <hr>
                <div id="Tin"><span>Trường Đại học Nguyễn Tất Thành hướng dẫn quy trình nhập học trực tuyến cho
            ...
            <div class="contentblock">
                <div class="link">
                    <a
                        ...
                        ĐH Nguyễn Tất Thành sẵn sàng chào đón tân sinh viên K72</a>
                </div>
                <hr>
                <div id="Tin">
        ...
        <div class="block">
            ...
            <div class="contentblock">
                ...
                <hr>
                <div id="Tin">
                    <span id="Tin">Hội đồng tuyển sinh Trường Đại học Nguyễn Tất Thành thông báo
    ...
    <div class="title">
        ...
        <div class="welcome">
            <span>
                Trường Đại học Nguyễn Tất Thành trực thuộc Bộ Giao thông vận tải là một trường đào tạo
            ...
            <br>
            <span>
                Trường Đại học Nguyễn Tất Thành hướng tới mô hình đại học đa ngành về kỹ thuật, công
            ...
            <div class="mota">
                <span>
                    Lịch sử trường Đại học Nguyễn Tất Thành
                </span>
            </div>
            <br>
        </div>
