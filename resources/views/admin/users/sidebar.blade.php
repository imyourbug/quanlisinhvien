<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.home') }}" class="brand-link">
        <img src="/template/admin/image/logoUTT.png" alt="AdminLTE Logo" class="brand-image img-square elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-light">NTT Management</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="/template/admin/image/logoUTTadmin.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
